export default{
    agreement:`If you live in any of the following countries, additional terms may apply to you and are viewable at the bottom of these Terms. We display the country within the Terms when applicable.  These additional terms override the Terms below to the extent of any inconsistency.

    Argentina, Australia, Brazil, Canada, Colombia, Korea, all European countries (including specific terms for Austria, Belgium, France, Germany, Hungary, Italy, Poland, Switzerland), and Japan.
    ...
    KOREA
    The following location-based service provider terms apply to your use of and access to the Nike Running Club app and the Nike Training Club app: location-based service provider terms. In the event of any conflict between the location-based service provider terms and these Terms, these Terms shall govern.
